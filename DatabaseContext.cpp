...
void DatabaseContext::initialize() {
	// Додавання студентів
	students.push_back(Student("John Doe", "Male", 2000, 1000, 1, 1));
	students.push_back(Student("Jane Smith", "Female", 2001, 1200, 2, 2));
	students.push_back(Student("Alice Johnson", "Female", 1999, 1100, 3, 3));
	students.push_back(Student("Robert Brown", "Male", 1998, 1300, 4, 4));
	students.push_back(Student("Emily Davis", "Female", 2000, 1000, 1, 1));
	students.push_back(Student("Michael Miller", "Male", 2002, 900, 2, 2));
	students.push_back(Student("Sarah Wilson", "Female", 2001, 1200, 3, 3));
	students.push_back(Student("David Martinez", "Male", 1999, 1150, 4, 4));

	// Додавання викладачів
	teachers.push_back(Teacher("Dr. Brown", "Male", 1975, true, 5000, "Professor", false, true, true));
	teachers.push_back(Teacher("Ms. Green", "Female", 1980, false, 4000, "Associate Professor", false, true, false));
	teachers.push_back(Teacher("Mr. White", "Male", 1985, true, 3500, "Lecturer", true, false, false));
	teachers.push_back(Teacher("Dr. Black", "Male", 1970, true, 5500, "Professor", false, true, true));
	teachers.push_back(Teacher("Ms. Blue", "Female", 1983, false, 4200, "Assistant Professor", true, false, false));
	teachers.push_back(Teacher("Mr. Red", "Male", 1978, true, 4600, "Senior Lecturer", false, true, true));
	teachers.push_back(Teacher("Dr. Yellow", "Female", 1982, false, 4800, "Associate Professor", false, true, true));
